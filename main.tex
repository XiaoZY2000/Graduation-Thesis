...
\begin{abstract}
	...
	assumption of overlapping users or items across domains during model training,
	an assumption that is frequently violated in real-world scenarios.
	...
	transport to enable knowledge transfer under non-overlapping training settings.
	Specifically, the proposed framework learns cross-domain transfer mechanisms
	without exploiting any overlapping users or items, and infers target-domain
	user preferences based on available observations at inference time.
	...
	even when overlapping information is unavailable during training.
	...
	preference modeling and the effectiveness of leveraging source-domain information
	to enhance target-domain recommendation performance.
\end{abstract}
