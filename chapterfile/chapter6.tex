...
over five independent runs with different random seeds. The detailed results of
each individual run for the proposed DUP-OT method are reported in
Appendix~\ref{chap:appendix} for completeness and reproducibility.
...
results for each individual run are reported in Appendix~\ref{chap:appendix}.
