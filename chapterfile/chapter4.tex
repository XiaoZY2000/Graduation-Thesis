...
\]
These component-wise distances are combined with the user-specific mixture weights to construct a distribution-aware representation of user--item compatibility:
\[
