...
These days, information overload has become a significant challenge for users in various online platforms, such as e-commerce websites, streaming services, and social media\cite{city23544, ijerph19138060, 10.1371/journal.pone.0284466}. Recommender systems play a crucial role in addressing this challenge by providing personalized guidance to users by selecting items with the highest predicted utility from a large space of options.\cite{resnick1997recommender,burke2002hybrid,Burke_Felfernig_Göker_2011}
...
Besides improving user experience, recommender systems also benefit businesses by increasing sales, customer retention, and overall platform activity\cite{10.1145/3370082}. As the volume of online content continues to grow, the importance of effective recommender systems becomes even more pronounced.
