...
preferences.
This issue is particularly severe in emerging or niche platforms with limited
interaction data.
...
Both data sparsity and cold-start problems stem from the limited availability of
...
under non-overlapping settings.
...
transfer even when no overlapping users or items are available during training.
