...
The second MLP takes as input the negative Mahalanobis distances between the item embedding and each Gaussian component,
weighted by the corresponding user-specific mixture weights.
In addition, a processed timestamp feature is concatenated to the input.
The MLP then outputs the predicted rating.
